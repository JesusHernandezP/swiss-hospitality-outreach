...
switch ($Action) {
    ...
    default {
        Write-Output "Usage: n8n-api.ps1 -Action <test|list-workflows|create-workflow|import-workflow|create-tag|list-tags|create-variable|list-variables> [-Data <json|filepath>]"
    }
}
